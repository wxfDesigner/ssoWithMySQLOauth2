...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8889/";
...
//    	String plainClientCredentials="5c08d89d0cac8b94510457e0:secret";
    ...
    private static void listAllUsers(AuthTokenInfo tokenInfo){
        ...
        ResponseEntity<List> response = restTemplate.exchange(REST_SERVICE_URI+"/consoleList/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void getUser(AuthTokenInfo tokenInfo){
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        ResponseEntity<Users> response = restTemplate.exchange(REST_SERVICE_URI+"/console/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void createUser(AuthTokenInfo tokenInfo) {
        ...
        URI uri = restTemplate.postForLocation(REST_SERVICE_URI+"/console/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
        		request, Users.class);
    ...
    private static void deleteUser(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        restTemplate.exchange(REST_SERVICE_URI+"/console/3"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void deleteAllUsers(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        restTemplate.exchange(REST_SERVICE_URI+"/console/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
        		HttpMethod.DELETE, request, Users.class);
    }
